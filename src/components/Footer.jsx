  ...
  return (
    <footer className="footer">
      ...
      <div className="footer-right">
        ...
        <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="footer-icon twitter">
          <img src="/images/twitter.png" alt="Twitter" />
        </a>
        <a href="https://github.com/SIAM-VIT" target="_blank" rel="noopener noreferrer" className="footer-icon twitter">
